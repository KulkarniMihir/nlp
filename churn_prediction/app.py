...
if prediction_prob > 0.5:
    st.write(f'The customer is predicted to churn with a probability of {prediction_prob:.2f}')
else:
    st.write(f'The customer is predicted to not churn with a probability of {1-prediction_prob:.2f}')